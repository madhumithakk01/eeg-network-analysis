...
| Package | Purpose |
|---------|---------|
| **data_loading** | Load EEG (e.g. WFDB) and metadata; channel consistency analysis across hospitals. |
...
- **batches/** — batch_1.csv … batch_4.csv; subset_100_ids_updated.csv for batch_0.
